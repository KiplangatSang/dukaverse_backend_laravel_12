...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sale_settings', function (Blueprint $table) {
            ...
            $table->bigInteger('salesettingable_id')->nullable();
            $table->string('salesettingable_type')->nullable();
            $table->foreignId('user_id')->references('id')->on('users')->onDelete('cascade');
            $table->boolean("allow_discounts")->default(true);
            $table->boolean("allow_online_payments")->default(true);
            ...
            $table->double("stock_required_when_below")->nullable()->default(10);
            $table->softDeletes();
            $table->timestamps();
        });
    }
